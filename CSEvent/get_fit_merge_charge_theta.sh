# # ------------------------------------------------------------------------------------
# Merge theta bin and charge on the 0th bin and the 2th bin to the 1st
mkdir results_fit_theta_cols_merge_charge
mkdir results_fit_theta_cols_merge_charge/P08_10
mkdir results_fit_theta_cols_merge_charge/P07_10
mkdir results_fit_theta_cols_merge_charge/P06_10
